...
/*
 * GetStatus Obtain server status
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @return ApiGetStatusRequest
 */
func (a *StatusApiService) GetStatus(ctx _context.Context) ApiGetStatusRequest {
	return ApiGetStatusRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 * @return Status
 */
func (a *StatusApiService) GetStatusExecute(r ApiGetStatusRequest) (Status, *_nethttp.Response, error) {
	var (
